...
- [x] Dzien 9: Pierwszy request z Vue do API przez typed API client.
- [x] Dzien 10: Review fundamentow: kiedy Pinia, kiedy local state, kiedy composable.
...
- [x] Dzien 16: `FeatureRequestController@index` z filtrowaniem i sortowaniem.
...
- [x] Dzien 24: Testy feature dla requestow, glosow i komentarzy.
- [x] Dzien 25: Review backendu feedback boarda.
...
- [x] Dzien 29: Publiczny board w PrimeVue DataTable.
- [x] Dzien 30: Formularz dodawania requestu w PrimeVue Dialog.
- [x] Dzien 31: Glosowanie z optimistic update i obsluga rollbacku.
